...
% --------------------------------------------------
	...
	This chapter introduces the concept of \ac{DP} and the Byzantine Fault Model.
...
\end{definition}
	...
	In our case, the local updates are to be protected from inference attacks by the aggregator or attackers eavesdropping on the client-server-communication, requiring local \ac{DP}. This is achieved by each client adding the noise locally before sharing the updates. The effective noise magnitude increases in this case because the masks on the individual updates add up, making local \ac{DP} more costly in terms of accuracy.
