...
\end{definition}
	...
	\placeholder{swap local vs global and dpsgd}
...
\placeholder{review}
	...
	The very large size of the root dataset compared to the size proposed in the original paper poses the risk of overstating the reliability of the FLTrust defense mechanism. The experiments should therefore be extended to verify the effect on smaller root datasets.
	...
	\begin{figure}[h]
		\centering
		\includegraphics[width=0.7\linewidth]{img/bytes_per_client.png}
	...
	\begin{figure}
		...
		\caption{The full training duration for varying numbers of clients.}
