...
\end{definition}
	...
	The performance metric includes communication cost (bytes sent per client per round), and wall-clock training time. These metrics collectively assess the trade-off between resource efficiency, and computational feasibility in decentralized learning systems.
	...
	The full results are available in table TODO
