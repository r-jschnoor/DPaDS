...
\placeholder{review}
	...
	\paragraph{Training in 50 rounds of one full epoch each.}
	...
	\paragraph{Training in 500 rounds of 10 batches each.}
	...
	Processing 5--20 batches per round preserves a clear separation between honest and malicious trust scores while maintaining high model accuracy. Among these configurations, 10 batches per round provide a favorable trade-off and are therefore used throughout the remainder of this work.
	...
	\begin{figure}[h]
		\includegraphics[width=0.9\linewidth]{img/MNIST_07-10/confusion_matrix_BASE}
		\caption{Final confusion matrices for standard FedAvg .}
		\label{fig:confusion_matrix_base}
	\end{figure}
	
	\begin{figure}[h]
		\includegraphics[width=0.9\linewidth]{img/MNIST_07-10/confusion_matrix_FLTRUST.png}
		\caption{Final confusion matrices for FLTrust config.}
		\label{fig:confusion_matrix_fltrust}
	\end{figure}
	
	\begin{figure}[h]
		\includegraphics[width=0.9\linewidth]{img/MNIST_07-10/confusion_matrix_DP+FLTRUST.png}
