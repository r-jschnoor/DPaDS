...
% --------------------------------------------------
	...
	\begin{longtable}{@{}l c c c c c@{}}
		\toprule
		\textbf{Configuration} & \textbf{Clients} & \textbf{$\varepsilon$} & \textbf{Top-$k$} & \textbf{$\Delta$ Accuracy} & \textbf{Final Accuracy} \\
		\midrule
		\endfirsthead
		\multicolumn{6}{c}{\tablename\ \thetable{} -- continued from previous page}\\
		\toprule
		\textbf{Configuration} & \textbf{Clients} & \textbf{$\varepsilon$} & \textbf{Top-$k$} & \textbf{$\Delta_{Accuracy}$} & \textbf{Final Accuracy} \\
		\midrule
		\endhead
		\midrule
		...
		\bottomrule
		\endlastfoot
		\multirow{3}{*}{\textbf{BASE}} & 10 & -- & -- & 0.0858 & 0.8936 \\
		& 30 & -- & -- & 0.0319 & 0.9475 \\
		& 60 & -- & -- & 0.0008 & 0.9785 \\
		\arrayrulecolor{gray!60}\midrule\arrayrulecolor{black}
		\multirow{6}{*}{\textbf{DP}} & 10 & 1 & -- & 0.1964 & 0.7830 \\
		& 30 & 1 & -- & 0.1844 & 0.7950 \\
		& 60 & 1 & -- & 0.1919 & 0.7874 \\
		& 10 & 10 & -- & 0.1824 & 0.7970 \\
		& 30 & 10 & -- & 0.1731 & 0.8063 \\
		& 60 & 10 & -- & 0.1773 & 0.8020 \\
		\arrayrulecolor{gray!60}\midrule\arrayrulecolor{black}
		\multirow{3}{*}{\textbf{FLTrust}} & 10 & -- & -- & 0.0055 & 0.9739 \\
		& 30 & -- & -- & 0.0012 & 0.9782 \\
		& 60 & -- & -- & -0.0005 & 0.9798 \\
		\arrayrulecolor{gray!60}\midrule\arrayrulecolor{black}
		\multirow{9}{*}{\textbf{TopK}} & 10 & -- & 0.01 & 0.0785 & 0.9009 \\
		...
		\arrayrulecolor{gray!60}\midrule\arrayrulecolor{black}
		\multirow{6}{*}{\textbf{DP + FLTrust}} & 10 & 1 & -- & 0.1022 & 0.8772 \\
		& 30 & 1 & -- & 0.0624 & 0.9170 \\
		& 60 & 1 & -- & 0.0458 & 0.9335 \\
		& 10 & 10 & -- & 0.1627 & 0.8167 \\
		& 30 & 10 & -- & 0.1439 & 0.8355 \\
		& 60 & 10 & -- & 0.1216 & 0.8577 \\
		\arrayrulecolor{gray!60}\midrule\arrayrulecolor{black}
		\multirow{18}{*}{\textbf{DP + TopK}} & 10 & 1 & 0.01 & 0.7768 & 0.2026 \\
		...
		\arrayrulecolor{gray!60}\midrule\arrayrulecolor{black}
		\multirow{9}{*}{\textbf{FLTrust + TopK}} & 10 & -- & 0.01 & 0.0510 & 0.9284 \\
		...
		\arrayrulecolor{gray!60}\midrule\arrayrulecolor{black}
		\multirow{18}{*}{\textbf{ALL}} & 10 & 1 & 0.01 & 0.3330 & 0.6464 \\
		...
		\caption{Final and delta accuracy (relative to the no-attack BASE run) across all evaluated configurations. Unless noted otherwise, all runs use $R_\ell=10$ local epochs, a Byzantine client fraction of $0.2$, and $500$ communication rounds.}
